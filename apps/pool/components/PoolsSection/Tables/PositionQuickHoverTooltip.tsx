...
interface PositionQuickHoverTooltip {
  row: {
    pair: Pair
  }
}

export const PositionQuickHoverTooltip = <T extends PositionQuickHoverTooltip>({ row }: T) => {
  return (
...
const _PositionQuickHoverTooltip: FC<PositionQuickHoverTooltip> = ({ row }) => {
