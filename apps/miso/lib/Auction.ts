import { Amount, Currency, Price, Token, Type } from '@sushiswap/currency'
...
export class Auction {
  ...
  public get totalTokensCommitted(): Amount<Type> | undefined {
    if (this.marketInfo?.commitments) {
      return Amount.fromRawAmount(this.paymentToken, JSBI.BigInt(this.marketInfo.commitments))
    }
  }
  ...
  public get rate(): Price<Token, Type> | undefined {
  ...
  public get totalTokens(): Amount<Token> | undefined {
    if (this.auctionInfo.totalTokens) {
      return Amount.fromRawAmount(this.auctionToken, JSBI.BigInt(this.auctionInfo.totalTokens))
    }
  }

  public get commitmentsTotal(): Amount<Type> | undefined {
    if (this.auctionInfo.commitmentsTotal) {
      return Amount.fromRawAmount(this.paymentToken, JSBI.BigInt(this.auctionInfo.commitmentsTotal))
    }
  }

  public get currentPrice(): Price<Token, Type> | undefined {
  ...
  public get reservePrice(): Price<Token, Type> | undefined {
  ...
  public get tokenPrice(): Price<Token, Type> | undefined {
    if (
  ...
  public get startPrice(): Price<Token, Type> | undefined {
  ...
  public get minimumPrice(): Price<Token, Type> | undefined {
    if (this.auctionInfo.minimumPrice) {
      return new Price(
        this.auctionToken,
        this.paymentToken,
  ...
  public get minimumCommitment(): Amount<Type> | undefined {
    if (this.template === AuctionTemplate.CROWDSALE) {
      if (this.totalTokens && this.rate) {
        const { denominator, numerator } = this.totalTokens.divide(this.rate)
        return Amount.fromFractionalAmount(this.paymentToken, numerator, denominator)
      }
    }
    ...
    if (this.template === AuctionTemplate.BATCH_AUCTION) {
      if (this.auctionInfo.minimumCommitmentAmount) {
        return Amount.fromRawAmount(this.paymentToken, JSBI.BigInt(this.auctionInfo.minimumCommitmentAmount))
      }
    }
  }

  public get minimumTargetRaised(): Amount<Type> | undefined {
    if (this.template === AuctionTemplate.BATCH_AUCTION) {
  ...
  public get maximumTargetRaised(): Amount<Type> | undefined {
  ...
  public tokenAmount(amount: Amount<Type>): Amount<Type> | undefined {
  ...
  public get tokensClaimable(): Amount<Type> | undefined {
    if (this.marketInfo?.tokensClaimable) {
      return Amount.fromRawAmount(this.auctionToken, JSBI.BigInt(this.marketInfo.tokensClaimable))
    }
  }
  ...
  public get liquidityAmount(): Amount<Token> | undefined {
    if (this.launcherInfo && this.liquidityToken) {
      return Amount.fromRawAmount(this.liquidityToken, JSBI.BigInt(this.launcherInfo.liquidityAdded))
    }
  }
}
